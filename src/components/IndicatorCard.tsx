import { Card, Color, ColorPalette, Flex, FormatNumber, Icon, Stat } from "@chakra-ui/react";
...
export function IndicatorCard({ icon, label, value, indicator, colorPalette }: IndicatorCardProps) {
